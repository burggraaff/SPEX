...
ax1.text(565, 0.18, "$I_1$", color=RGB_OkabeIto[0], ha="right", va="top")
ax1.text(600, 0.13, "$I_2$", color=RGB_OkabeIto[2], ha="right", va="top")
ax1.text(580, 0.82, "$I = I_1 + I_2$", color='k', ha="left", va="bottom")
ax1.set_xlabel("Wavelength [nm]")
ax1.set_xlim(wavelengths.min(), wavelengths.max())
ax1.set_xticks(np.arange(400,701,100))
